...
Phase 1  需求工程
│  /requirement
│  產出：User Stories + Acceptance Criteria
▼
Phase 2  規格設計
│  /sdd
│  產出：SPEC-XXX.md（Approved）
▼
Phase 3  測試推導
│  /derive all
│  產出：三種測試骨架
...
[TODO] markers     Gherkin 場景       驗收條件
│                  │                  │
▼                  ▼                  ▼
Phase 4  單元測試   Phase 5  整合測試   Phase 6  品質驗證
/tdd               /bdd               /coverage
                                      /refactor
產出：              產出：              /review
✅ Unit Tests      ✅ Integration      /checkin
✅ 實作程式碼       ✅ E2E Tests
│                  │                  產出：
└─────→ 匯入 ──────┘                  ✅ 覆蓋率報告
                   │                  ✅ 審查報告
                   └──── 匯入 ────────┘
                              ...
                              │  產出：Git Tag, CHANGELOG
                              ▼
                              Phase 8  上線投產（UDS 範圍外）
                                 環境配置 → 部署 → 監控 → 正式上線
```
